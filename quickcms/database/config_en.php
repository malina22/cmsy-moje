...
*/
$config['description'] = "Fast and simple content management system. The script is written in PHP language based on file database, and compatible with XHTML 1.1 and WAI standards.";
